...
/* Thread-local storage specifier compatible with C and C++ */
#if !defined(UVGRTP_THREAD_LOCAL)
#if defined(__cplusplus)
#define UVGRTP_THREAD_LOCAL thread_local
#elif defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)
#define UVGRTP_THREAD_LOCAL _Thread_local
#elif defined(_MSC_VER)
#define UVGRTP_THREAD_LOCAL __declspec(thread)
#else
#define UVGRTP_THREAD_LOCAL __thread
#endif
#endif
...
extern UVGRTP_THREAD_LOCAL rtp_error_t rtp_errno;
